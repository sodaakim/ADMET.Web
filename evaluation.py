        ...
        properties = [ # property
            ...
            {'title': 'Physicochemical Properties',
             'contents': [
                ...
                {'subtitle': 'logS',                    'model1': '   ',    'model2': '   ',    'model3': 'num',                                               'color': '#103B59', 'tooltipText': 'logS (Water Solubility): The logarithm of the water solubility of a substance.'},
                ...
                {'subtitle': 'logD',                    'model1': '   ',    'model2': '   ',    'model3': 'num',                                               'color': '#103B59', 'tooltipText': 'logD: The logarithm of the distribution coefficient.'},
                {'subtitle': 'DMSO',                    'model1': '   ',    'model2': '   ',    'model3': 'num',                                               'color': '#103B59', 'tooltipText': 'DMSO (Dimethyl sulfoxide): A polar aprotic solvent commonly used in organic chemistry.'},
                ...
                {'subtitle': 'nRing',                   'model1': '   ',    'model2': '   ',    'model3': 'num',                                               'color': '#103B59', 'tooltipText': 'nRing (Num. rings): The number of rings in a molecule.'},
                {'subtitle': 'nHet',                    'model1': '   ',    'model2': '   ',    'model3': 'num',                                               'color': '#103B59', 'tooltipText': 'nHet (Num. heteroatoms): The number of heteroatoms (non-carbon atoms) in a molecule.'},
                {'subtitle': 'nRig',                    'model1': '   ',    'model2': '   ',    'model3': 'num',                                               'color': '#103B59', 'tooltipText': 'nRig (Num. rigid bonds): The number of bonds in a molecule that are rigid and cannot rotate freely.'},
                {'subtitle': 'pKa',                     'model1': '   ',    'model2': '   ',    'model3': 'num',                                               'color': '#103B59', 'tooltipText': 'pKa: The negative logarithm of the acid dissociation constant (Ka) of a substance, representing the strength of an acid in solution.'}
            ]},
